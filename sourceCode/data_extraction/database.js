...
exports.saveNewsData = exports.saveNBAData = void 0;
//Import AWS modules
...
function saveNBAData(team, homeTeam, timestamp, awayTeam, points, scoreDifference) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    err_1 = _a.sent();
                    console.error("ERROR uploading NBA data: " + JSON.stringify(err_1));
                    throw err_1;
...
function saveNewsData(title, publishedAt, teamName) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    err_2 = _a.sent();
                    console.error("ERROR uploading news data: " + JSON.stringify(err_2));
                    throw err_2;
                case 4: return [2 /*return*/];
            }
        });
...
exports.saveNewsData = saveNewsData;
